...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$3, 57, 18, 2059);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	let t5;
    	let span2;
    	let t6_value = /*remaining*/ ctx[8].hours + "";
    	let t6;
    	let t7;
    	let span3;
    	let t9;
    	let span4;
    	let t10_value = /*remaining*/ ctx[8].minutes + "";
    	let t10;
    	let t11;
    	let span5;
    	let t13;
    	let span6;
    	let t14_value = /*remaining*/ ctx[8].seconds + "";
    	let t14;
    	...
    	const block = {
    		c: function create() {
    			...
    			span6 = element("span");
    			t14 = text(t14_value);
    			add_location(h5, file$3, 48, 18, 1699);
    			add_location(span0, file$3, 49, 18, 1729);
    			add_location(span1, file$3, 50, 18, 1777);
    			add_location(span2, file$3, 51, 18, 1812);
    			add_location(span3, file$3, 52, 18, 1861);
    			add_location(span4, file$3, 53, 18, 1896);
    			add_location(span5, file$3, 54, 18, 1947);
    			add_location(span6, file$3, 55, 18, 1982);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*remaining*/ 256 && t6_value !== (t6_value = /*remaining*/ ctx[8].hours + "")) set_data_dev(t6, t6_value);
    			if (dirty & /*remaining*/ 256 && t10_value !== (t10_value = /*remaining*/ ctx[8].minutes + "")) set_data_dev(t10, t10_value);
    			if (dirty & /*remaining*/ 256 && t14_value !== (t14_value = /*remaining*/ ctx[8].seconds + "")) set_data_dev(t14, t14_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(48:18) {#if remaining.done === false}",
    		ctx
    	});
    ...
    // (42:12) <Countdown              from='2022-11-09 09:30:00'             dateFormat="YYYY-MM-DD HH:mm:ss"              zone="Europe/Athens"             let:remaining>
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "flex flex-row justify-center space-x-3 text-3xl text-center text-gray-800");
    			add_location(div, file$3, 46, 15, 1524);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(42:12) <Countdown              from='2022-11-09 09:30:00'             dateFormat=\\\"YYYY-MM-DD HH:mm:ss\\\"              zone=\\\"Europe/Athens\\\"             let:remaining>",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$3, 27, 5, 572);
    			attr_dev(h4, "id", "name");
    			attr_dev(h4, "class", "font-semibold text-center text-1xl");
    			add_location(h4, file$3, 31, 9, 781);
    			...
    			add_location(span0, file$3, 33, 12, 912);
    			attr_dev(div1, "class", "flex justify-center");
    			add_location(div1, file$3, 32, 9, 866);
    			attr_dev(h60, "class", "text-base text-center");
    			add_location(h60, file$3, 36, 12, 1155);
    			attr_dev(h61, "class", "text-base text-center");
    			add_location(h61, file$3, 37, 12, 1221);
    			attr_dev(div2, "id", "launchInformation");
    			attr_dev(div2, "class", "mb-1");
    			add_location(div2, file$3, 35, 9, 1101);
    			attr_dev(p0, "class", "text-xs text-center");
    			add_location(p0, file$3, 63, 15, 2247);
    			add_location(span1, file$3, 64, 15, 2302);
    			attr_dev(p1, "class", "text-xs text-center");
    			add_location(p1, file$3, 65, 15, 2332);
    			add_location(span2, file$3, 66, 15, 2388);
    			attr_dev(p2, "class", "text-xs text-center");
    			add_location(p2, file$3, 67, 15, 2418);
    			add_location(span3, file$3, 68, 15, 2473);
    			attr_dev(p3, "class", "text-xs text-center");
    			add_location(p3, file$3, 69, 15, 2503);
    			attr_dev(div3, "class", "flex flex-row justify-center space-x-2 pl-11");
    			add_location(div3, file$3, 62, 12, 2173);
    			attr_dev(div4, "id", "launchTime");
    			add_location(div4, file$3, 39, 9, 1305);
    			attr_dev(h62, "class", "text-base text-center");
    			add_location(h62, file$3, 73, 12, 2635);
    			attr_dev(h63, "id", "timer");
    			attr_dev(h63, "class", "text-base text-center");
    			add_location(h63, file$3, 74, 12, 2693);
    			attr_dev(div5, "id", "date");
    			attr_dev(div5, "class", "mt-2 mb-2");
    			add_location(div5, file$3, 72, 9, 2589);
    			attr_dev(div6, "id", "body");
    			attr_dev(div6, "class", "flex flex-col ml-5");
    			add_location(div6, file$3, 30, 6, 729);
    			attr_dev(div7, "class", "w-2/3 p-2 md:text-lg");
    			add_location(div7, file$3, 29, 5, 688);
    			attr_dev(div8, "class", "flex w-auto overflow-hidden bg-white rounded-lg shadow-lg h-60");
    			add_location(div8, file$3, 26, 3, 490);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*date*/ 8) set_data_dev(t21, /*date*/ ctx[3]);
    			if (!current || dirty & /*time*/ 16) set_data_dev(t23, /*time*/ ctx[4]);
    		},
    		i: function intro(local) {
    			if (current) return;
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		$$invalidate(7, events = await getData());
    	});
    ...
    class Card extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*launchTitle*/ ctx[0] === undefined && !("launchTitle" in props)) {
    			console_1.warn("<Card> was created without expected prop 'launchTitle'");
    		}

    		if (/*organization*/ ctx[1] === undefined && !("organization" in props)) {
    			console_1.warn("<Card> was created without expected prop 'organization'");
    		}

    		if (/*launchPadLocation*/ ctx[2] === undefined && !("launchPadLocation" in props)) {
    			console_1.warn("<Card> was created without expected prop 'launchPadLocation'");
    		}

    		if (/*date*/ ctx[3] === undefined && !("date" in props)) {
    			console_1.warn("<Card> was created without expected prop 'date'");
    		}

    		if (/*time*/ ctx[4] === undefined && !("time" in props)) {
    			console_1.warn("<Card> was created without expected prop 'time'");
    		}

    		if (/*rocketStatus*/ ctx[5] === undefined && !("rocketStatus" in props)) {
    			console_1.warn("<Card> was created without expected prop 'rocketStatus'");
    		}

    		if (/*rocketImage*/ ctx[6] === undefined && !("rocketImage" in props)) {
    			console_1.warn("<Card> was created without expected prop 'rocketImage'");
    		}
    	}
    ...
    // (20:1) { #each events as {name, image, pad, net, launch_service_provider, status}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(20:1) { #each events as {name, image, pad, net, launch_service_provider, status}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 18, 0, 366);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
