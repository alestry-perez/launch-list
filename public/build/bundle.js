...
var app = (function () {
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<Countdown> was created with unknown prop '${key}'`);
    	});
    ...
    class Countdown extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*from*/ ctx[2] === undefined && !("from" in props)) {
    			console_1.warn("<Countdown> was created without expected prop 'from'");
    		}

    		if (/*dateFormat*/ ctx[1] === undefined && !("dateFormat" in props)) {
    			console_1.warn("<Countdown> was created without expected prop 'dateFormat'");
    		}

    		if (/*zone*/ ctx[3] === undefined && !("zone" in props)) {
    			console_1.warn("<Countdown> was created without expected prop 'zone'");
    		}
    	}
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$3, 46, 18, 1860);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			span6 = element("span");
    			t14 = text(t14_value);
    			add_location(h5, file$3, 37, 18, 1500);
    			add_location(span0, file$3, 38, 18, 1530);
    			add_location(span1, file$3, 39, 18, 1578);
    			add_location(span2, file$3, 40, 18, 1613);
    			add_location(span3, file$3, 41, 18, 1662);
    			add_location(span4, file$3, 42, 18, 1697);
    			add_location(span5, file$3, 43, 18, 1748);
    			add_location(span6, file$3, 44, 18, 1783);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$3, 51, 15, 2035);
    			add_location(span1, file$3, 52, 15, 2090);
    			attr_dev(p1, "class", "text-xs text-center");
    			add_location(p1, file$3, 53, 15, 2120);
    			add_location(span2, file$3, 54, 15, 2176);
    			attr_dev(p2, "class", "text-xs text-center");
    			add_location(p2, file$3, 55, 15, 2206);
    			add_location(span3, file$3, 56, 15, 2261);
    			attr_dev(p3, "class", "text-xs text-center");
    			add_location(p3, file$3, 57, 15, 2291);
    			attr_dev(div3, "class", "flex flex-row justify-center pl-10 space-x-3");
    			add_location(div3, file$3, 50, 12, 1961);
    			attr_dev(div4, "id", "launchTime");
    			add_location(div4, file$3, 29, 9, 1125);
    			attr_dev(h62, "class", "text-base text-center");
    			add_location(h62, file$3, 61, 12, 2421);
    			attr_dev(h63, "id", "timer");
    			attr_dev(h63, "class", "text-base text-center");
    			add_location(h63, file$3, 62, 12, 2479);
    			attr_dev(div5, "id", "date");
    			attr_dev(div5, "class", "mt-2 mb-2");
    			add_location(div5, file$3, 60, 9, 2375);
