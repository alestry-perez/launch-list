    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h4, "class", "text-6xl font-bold text-center text-white no-underline uppercase hover:text-blue-dark");
    			add_location(h4, file$2, 6, 4, 208);
    			attr_dev(div, "class", "mb-2 sm:mb-0");
    			add_location(div, file$2, 5, 2, 177);
    			attr_dev(nav, "class", "flex flex-col w-full p-4 px-6 py-4 text-center text-black bg-gray-900 sm:flex-row sm:text-left sm:justify-between sm:items-baseline pin-b");
    			add_location(nav, file$2, 4, 0, 23);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			div0 = element("div");
    			div0.textContent = "Made with ❤️ by Alestry Pérez 2021";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 20, 0, 393);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
